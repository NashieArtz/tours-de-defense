...
/**
 * Niveau 1 du jeu de tour de défense.
 *
 */
public class NiveauTD_1 implements Niveau {
    ...
    // Palette pour les tuiles à dessiner
    ...
    /* Carte du niveau
     * Index = 0 (vide), toutes autres valeurs = tuile à dessiner
     */
    ...
    // Emplacement dse tours constructibles
    ...
    // Chemin que suivront les ennemis
    ...
    // Ennemis
    public static final Ennemi LAPIN = new Ennemi( NiveauTD_1.CHEMIN, 0.8, 10, 10, Constantes.E_LAPIN, BitMap.LAPIN );
    public static final Ennemi TORTUE = new Ennemi( NiveauTD_1.CHEMIN, 1.5, 4, 10, Constantes.E_TORTUE, BitMap.TORTUE );
    public static final Ennemi BOSS = new Ennemi( NiveauTD_1.CHEMIN, 0.5, 100, 100, Constantes.E_BOSS, BitMap.BOSS );

    // Vagues d'ennemis: délai initial, l'intervalle, modèle, quantité
